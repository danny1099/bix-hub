...
export const ResetPasswordSteps = () => {
  ...
  return (
    <section className="flex size-full flex-col items-center justify-center py-6">
      <article className="bg-background mt-5 flex size-full flex-col items-center">
        <StepsIndicator />
        ...
        <Button variant="ghost" icon="refresh" place="start" onClick={handleGoBack} className="text-muted-foreground text-2xs mt-2 hover:underline">
          {t("navigate")}
        </Button>
      </article>
    </section>
